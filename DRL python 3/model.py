...
class Gen_Model():
	...
	def read(self, game, version):
		return load_model(config.RUN_FOLDER + game + '/models/version' + "{0:0>4}".format(version) + '.h5', custom_objects={'softmax_cross_entropy_with_logits': softmax_cross_entropy_with_logits})
