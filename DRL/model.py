...
class Gen_Model():
	...
	def write(self, game, version):
		self.model.save(config.RUN_FOLDER + game + '/models/version' + "{0:0>4}".format(version) + '.h5')

	def read(self, game, version):
		# return load_model(config.RUN_FOLDER + game + '/models/version' + "{0:0>4}".format(version) + '.h5')
		return load_model(config.RUN_FOLDER + game + '/models/version' + "{0:0>4}".format(version) + '.h5', compile=False)
